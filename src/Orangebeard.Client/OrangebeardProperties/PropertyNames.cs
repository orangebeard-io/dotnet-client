...
namespace Orangebeard.Client.OrangebeardProperties
{
    class PropertyNames
    {
        public static readonly string ORANGEBEARD_PROPERTY_FILE = "orangebeard.properties";
        public static readonly string ORANGEBEARD_ENDPOINT = "orangebeard.endpoint";
        public static readonly string ORANGEBEARD_PROJECT = "orangebeard.project";
